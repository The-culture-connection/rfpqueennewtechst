      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-gray-800/80 backdrop-blur-lg border border-pink-400/30 rounded-xl shadow-2xl shadow-pink-500/20 p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-pink-200/80 mt-2">Create your account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="••••••••"
              />
              <p className="text-xs text-pink-300/70 mt-1">Minimum 6 characters</p>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-pink-200/80">
              ...
              <Link href="/login" className="text-pink-400 hover:text-pink-300 font-medium underline decoration-pink-400/50">
                Log in
              </Link>
            </p>
          </div>
